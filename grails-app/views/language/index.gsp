		...
		<div id="list-language" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="music" title="${message(code: 'language.music.label', default: 'Music')}" />
					
						<g:sortableColumn property="type" title="${message(code: 'language.type.label', default: 'Type')}" />
				...
				<g:each in="${languageInstanceList}" status="i" var="languageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: languageInstance, field: "music")}</td>
					
						<td>${fieldValue(bean: languageInstance, field: "type")}</td>
