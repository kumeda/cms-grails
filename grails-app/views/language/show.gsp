	...
	<body>
		...
		<div id="show-language" class="content scaffold-show" role="main">
			...
			<ol class="property-list language">
				...
				<g:if test="${languageInstance?.music}">
				<li class="fieldcontain">
					<span id="music-label" class="property-label"><g:message code="language.music.label" default="Music" /></span>
					
						<span class="property-value" aria-labelledby="music-label"><g:fieldValue bean="${languageInstance}" field="music"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${languageInstance?.type}">
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="language.type.label" default="Type" /></span>
					
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${languageInstance}" field="type"/></span>
